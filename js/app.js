...
buttonArray.forEach(country => {
  let buttons = document.createElement('button')
  buttons.id = country
  buttons.innerText = country
  buttons.classList = 'btn-item btn btn-outline-dark'
 buttons.classList.add('d-inline') // button elementinin oluşmasıyla beraberinde gelecek class isimlerini direkt olarak classList ile belirledik fakat sonradan bir class daha eklenmek istenirse classList.add('') kullanılmalıdır.(bu kod ikisi arasında farkı anlamak için oluşturmuştur aslında sadece classList ile yapılabilecek bir durumdur.)
...
let chınaBtn = document.getElementById('China')
